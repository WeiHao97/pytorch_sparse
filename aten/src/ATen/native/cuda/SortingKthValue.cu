...
std::tuple<Tensor&, Tensor&> kthvalue_out_cuda(
    ...
    int64_t dim,
    bool keepdim) {
  AT_DISPATCH_ALL_TYPES_AND2(at::ScalarType::Half, at::ScalarType::BFloat16, self.scalar_type(), "kthvalue_cuda", [&] {
...
Tensor median_cuda(const Tensor& self) {
  return AT_DISPATCH_ALL_TYPES_AND2(at::ScalarType::Half, at::ScalarType::BFloat16, self.scalar_type(), "median", [&] {
